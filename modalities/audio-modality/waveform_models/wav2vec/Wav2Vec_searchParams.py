...
from transformers import Wav2Vec2Config, AutoFeatureExtractor, Wav2Vec2ForSequenceClassification
...
pretrained_model = "superb/wav2vec2-base-superb-er" 
...
for params in ParameterGrid(param_grid):
    ...
    for train_index, val_index in kf.split(train_df['annotation_label'].astype(int).tolist()):
        ...
        training_args = TrainingArguments(
            output_dir="./runs/distilhubert_classifier",
            overwrite_output_dir=True,
            # logging_dir="./logs/distilhubert_classifier",
