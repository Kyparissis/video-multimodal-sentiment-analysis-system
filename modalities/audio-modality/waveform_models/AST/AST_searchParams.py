...
from transformers import ASTFeatureExtractor, ASTConfig, ASTForAudioClassification, ASTModel
...
warnings.filterwarnings("ignore", message=".*Some weights of ASTForAudioClassification were not initialized from the model checkpoint.*")
    ...
    for train_index, val_index in kf.split(train_df['annotation_label'].astype(int).tolist()):
        ...
        model.classifier = nn.Sequential(
            OrderedDict([
                ...
                ('dense', nn.Linear(model.config.hidden_size, params['hidden_size'])),
