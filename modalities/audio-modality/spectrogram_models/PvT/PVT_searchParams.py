...
from transformers import PvtImageProcessor, PvtConfig, PvtForImageClassification
...
pretrained_model = "Zetatech/pvt-small-224"
image_processor = PvtImageProcessor.from_pretrained(pretrained_model)
...
imageSizeHeight = image_processor.size['height']
imageSizeWidth = image_processor.size['width']
...
config = PvtConfig.from_pretrained(pretrained_model)
...
for params in ParameterGrid(param_grid):
    ...
    for train_index, val_index in kf.split(train_df['annotation_label'].astype(int).tolist()):
        ...
        model = PvtForImageClassification.from_pretrained(pretrained_model, 
                                                            config=config, 
        ...
        model.classifier = nn.Sequential(
            OrderedDict([
                ...
                ('dense', nn.Linear(512, params['hidden_size'])),
        ...
        training_args = TrainingArguments(
            output_dir="./runs/pvt_classifier",
            overwrite_output_dir=True,
            # logging_dir="./logs/pvt_classifier",
