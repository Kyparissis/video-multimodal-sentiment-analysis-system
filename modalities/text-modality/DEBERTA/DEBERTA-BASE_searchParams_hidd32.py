...
model_name = 'DEBERTA'
# Base path
base_path = '/home/k/kyparkypar/ondemand/data/sys/myjobs/projects/default/text-modality/DEBERTA/'
# Log file path
...
for params in ParameterGrid(param_grid):
    ...
    for train_index, val_index in kf.split(train_seq):
        ...
        model = DeBERTa_Arch(deberta, params['dropout_p'], params['hidden_size'], params['activation_fn'])
