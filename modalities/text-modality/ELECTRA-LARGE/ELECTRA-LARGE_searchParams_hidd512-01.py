...
# Base path
base_path = '/home/k/kyparkypar/ondemand/data/sys/myjobs/projects/default/text-modality/ELECTRA-LARGE/'
# Log file path
...
class ELECTRA_Arch(nn.Module):
    def __init__(self, electra, dropout_p=0.1, hidden_size=1024, activation_fn='No'):
        ...
        # FC Layer
        self.fc = nn.Linear(1024, hidden_size)   # ELECTRA outputs 1024 by default
        # Output layer
        # MULTILABEL CLASSIFICATION
...
for params in ParameterGrid(param_grid):
    ...
    for train_index, val_index in kf.split(train_seq):
        ...
        electra = AutoModel.from_pretrained('google/electra-large-discriminator')
