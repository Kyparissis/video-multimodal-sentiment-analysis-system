...
model_name = 'ALBERT'
# Base path
base_path = '/home/k/kyparkypar/ondemand/data/sys/myjobs/projects/default/text-modality/ALBERT/'
# Log file path
...
class ALBERT_Arch(nn.Module):
    def __init__(self, albert, dropout_p=0.1, hidden_size=768, activation_fn='No'):
        ...
        # FC Layer
        self.fc = nn.Linear(768, hidden_size)  # ALBERT outputs 768 by default
        # Output layer
        # MULTILABEL CLASSIFICATION
    ...
    def forward(self, sent_id, mask):
        ...
        outputs = self.albert(sent_id, attention_mask=mask)
...
for params in ParameterGrid(param_grid):
    ...
    for train_index, val_index in kf.split(train_seq):
        ...
        model = ALBERT_Arch(albert, params['dropout_p'], params['hidden_size'], params['activation_fn'])
