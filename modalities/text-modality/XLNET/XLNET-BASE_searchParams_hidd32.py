...
model_name = 'XLNET'
# Base path
base_path = '/home/k/kyparkypar/ondemand/data/sys/myjobs/projects/default/text-modality/XLNET/'
# Log file path
...
class XLNET_Arch(nn.Module):
    def __init__(self, XLNET, dropout_p=0.1, hidden_size=768, activation_fn='No'):
    ...
    def forward(self, sent_id, mask):
        ...
        outputs = self.XLNET(sent_id, attention_mask=mask)
        last_hidden_state = outputs[0]
        cls_hs = torch.mean(last_hidden_state, 1)        
        # ----------------------------------------------------------------
...
for params in ParameterGrid(param_grid):
    ...
    for train_index, val_index in kf.split(train_seq):
        ...
        model = XLNET_Arch(XLNET, params['dropout_p'], params['hidden_size'], params['activation_fn'])
