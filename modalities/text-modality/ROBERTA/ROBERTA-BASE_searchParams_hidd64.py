...
model_name = 'ROBERTA'
# Base path
base_path = '/home/k/kyparkypar/ondemand/data/sys/myjobs/projects/default/text-modality/ROBERTA/'
# Log file path
...
class RoBERTa_Arch(nn.Module):
    def __init__(self, roberta, dropout_p=0.1, hidden_size=768, activation_fn='No'):
        ...
        # FC Layer
        self.fc = nn.Linear(768, hidden_size)   # RoBERTa outputs 768 by default
        # Output layer
        # MULTILABEL CLASSIFICATION
    ...
    def forward(self, sent_id, mask):
        ...
        cls_hs = outputs[0][:, 0, :]  # CLS token is at index 0 in the sequence
        # ----------------------------------------------------------------
...
for params in ParameterGrid(param_grid):
    ...
    for train_index, val_index in kf.split(train_seq):
        ...
        model = RoBERTa_Arch(roberta, params['dropout_p'], params['hidden_size'], params['activation_fn'])
