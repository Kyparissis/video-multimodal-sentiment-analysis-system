...
# Subjob name
subjob_name = 'hidd128-03'
# Model name
model_name = 'ROBERTA-LARGE'
# Base path
base_path = '/home/k/kyparkypar/ondemand/data/sys/myjobs/projects/default/text-modality/ROBERTA-LARGE/'
# Log file path
...
class RoBERTa_Arch(nn.Module):
    def __init__(self, roberta, dropout_p=0.1, hidden_size=1024, activation_fn='No'):
        ...
        # FC Layer
        self.fc = nn.Linear(1024, hidden_size)   # RoBERTa LARGE outputs 1024 by default
        # Output layer
        # MULTILABEL CLASSIFICATION
